...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWndEx)
	...
	ON_WM_SETTINGCHANGE()
	ON_COMMAND(ID_VIEW_RENORMALIZATION, &CMainFrame::OnViewRenormalization)
	ON_UPDATE_COMMAND_UI(ID_VIEW_RENORMALIZATION, &CMainFrame::OnUpdateViewRenormalization)
...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	lstBasicCommands.AddTail(ID_VIEW_RENORMALIZATION);
...
void CMainFrame::OnViewRenormalization()
{
...
void CMainFrame::OnUpdateViewRenormalization(CCmdUI *pCmdUI)
{
	...
	if (!doc->finishedCalc)
	{
		...
		pCmdUI->Enable();
		pCmdUI->SetCheck(doc->displayingRenormalization ? TRUE : FALSE);
	}
}


CIsingMonteCarloDoc* CMainFrame::GetDocument()
{
...
void CMainFrame::OnSimulateRun()
{
	...
	if (doc->computing) {
		doc->StopThreads();
		doc->GetView()->EndWaitCursor();
	}
	else doc->LaunchThreads();
}
